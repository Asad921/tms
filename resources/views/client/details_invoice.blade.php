...
<head>
  ...
  <title>Client Invoice Details</title>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    justify-content: space-between;">Invoice Details
                        <a type="button" href="{{ route('client.pdf_download',$invoices->id) }}" class="btn btn-success" data-toggle="modal" data-target="#addmenu">
                          Get Invoice
                        </a>
                    </h6>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p>{{$invoices->cli ? $invoices->cli->name : 'N/A' }}</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
