        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.up_update',$profile->id) }}" method="POST" id="editForm" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('user.dashboard') }}" class="btn btn-danger"  data-dismiss="modal">Cancel</a>
