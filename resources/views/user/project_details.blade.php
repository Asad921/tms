...
<head>
  ...
  <title>Users Projects Details</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('user.project') }}">Project</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                      <label for="name" class="font-weight-bold">Project Pending Task:</label>
                      @if ($project->task != "")
                      @foreach($project->task->sortByDesc('priority')->where('status','0') as $info)
                        ...
                        <p >
                            ...
                            <b>
                              @if ($info->priority == 4)
                                {{ 'Highest' }}
                              @elseif ($info->priority == 3)
                                {{ 'High' }}
                              @elseif ($info->priority == 2)
                                {{ 'Meduim' }}
                              @elseif ($info->priority == 1)
                                {{ 'Low' }}
                              @endif
                            </b>
                        </p>
              ...
              <div class="col-md-3">
                <div class="form-group">
                    <label for="name" class="font-weight-bold">Project Completed Task:</label>
                    @if ($project->task != "")
                    @foreach($project->task->where('status','1')->pluck('title') as $info) 
                      <p >
                          {{ $info }}
                      </p>
