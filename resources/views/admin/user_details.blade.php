    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="name" class="font-weight-bold">Salary:</label>
                        <p>N/A</p>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <br>
                        <p>{{ count($user->task->where('status','0')) }}</p>
                    </div>
                </div>
                
                <div class="col-md-3">
                  <div class="form-group">
                      <label for="open_tasks" class="font-weight-bold">Pending Task Name:</label>
                    
                      {{-- <p>{{ implode(',', $user->task->pluck('title')->toArray()) }}</p> --}}
                          @if ($user->task != "")
                            @foreach($user->task->where('status','0')->pluck('title') as $info) 
                              <p >
                                  {{ $info }}
                              </p>
              ...
              <div class="col-md-3">
                <div class="form-group">
                    <label for="open_tasks" class="font-weight-bold">Completed Task Name:</label>
                  
                    {{-- <p>{{ implode(',', $user->task->pluck('title')->toArray()) }}</p> --}}
                        @if ($user->task != "")
                          @foreach($user->task->where('status','1')->pluck('title') as $info) 
                            <p >
                                {{ $info }}
                            </p>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <br>
             <img id='showImage' class="img-thumbnail thumbnail-preview" src="https://ui-avatars.com/api/?name={{ $user->name }}&amp;size=64&amp;rounded=true&amp;color=fff&amp;background=fc6369">
                                            </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                      <label for="open_tasks" class="font-weight-bold">Completed Tasks:</label>
                      <br>
                      <p>{{ count($user->task->where('status','1')) }}</p>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {{-- <span>{{ $user->proj->name }}</span> --}}
                        @if ($user->userProjects != "")
                            @foreach($user->userProjects->pluck('name') as $project) 
                              <p >
                                  {{ $project }}
                              </p>
