                ...
                <div class="modal fade" id="addmenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.invoice_store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    @csrf
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Invoice_From" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Client_name</label>
                                        <select name="clients" class="form-control" placeholder=" Select User" required>
                                            <option value="roles">Select Client</option>
                                            @foreach ($users->where('utype','CLI') as $user)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="invoice_no" class="form-control" placeholder="Invoice_Number" >
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Project_name</label>
                                        <select name="project" class="form-control" placeholder=" Select projects" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="issue_date" class="form-control" placeholder="Enter Issue Date" required>
        
                                        
                                    </div>
                                    <div class="form-group">
                                        <label>Due Date</label>
                                        <input type="date" name="due_date" class="form-control" placeholder="Enter Due_date" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tax</label>
                                        <input type="text" name="tax" class="form-control" placeholder="Enter Tax" optional>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_bill" class="form-control" placeholder="Enter total bill" >
                                    ...
                                    <div class="form-group">
                                        <label>Notes</label>
                                        <textarea class="form-control" name="notes" placeholder="Enter Notes">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        justify-content: space-between;">Invoice
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addmenu" >
                               Create Invoice 
                            </button>
                        </h6>
                    </div>
          ...
          @foreach ($invoices as $invoice )
            {{-- <div class="col-md-3" id="datatable">
              <div class="livewire-card card author-box shadow mb-5 rounded client-card-view hover-card"
                style="border-top: 3px solid #FFC300">
                  ...
                  <div class="ml-2 w-100 mb-auto">
                    ...
                    <a class="dropdown dropdown-list-toggle" style="margin-left: 145px; ">
                      <a href="#" data-toggle="dropdown"
                          class="notification-toggle action-dropdown  position-xs-bottom" style="color:#FFC300">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="d-flex" >
                                <h4 class="text-warning invoice-clients invoice_title" >
                                    <a class="text-warning" href="{{ url('detail_invoices',$invoice->id) }}">{{ $invoice->name }}</a>
                                </h4>
                                <br>&nbsp;
                                <p href="" class=" ">
                                    (<small class="text-warning"  >{{ $invoice->invoice_no }}</small>)
                        ...
                        <a class="dropdown dropdown-list-toggle"></a><a href="#" data-toggle="dropdown" class="notification-toggle action-dropdown itemDrp mr-1 " style="color:#FFC300; "><i class="fas fa-ellipsis-v"></i></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-l  ist-content dropdown-list-icons">
                                    <a href="{{ route('admin.invoice_edit',$invoice->id) }}" class="dropdown-item dropdown-item-desc edit-btn"><i class="fas fa-edit mr-2 card-edit-icon"></i>Edit
                                    </a>
                                    <a href="{{ route('admin.invoices_delete',$invoice->id) }}" class="dropdown-item dropdown-item-desc delete-btn" data-id="4"><i class="fas fa-trash mr-2 card-delete-icon"></i>Delete
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="d-table w-100">
                            <span class="d-table-row w-100 invoice-project-tooltip-hover">
                                <span class="d-table-cell w-100 invoice-projects ">
                                    <div class="invoice-project-tooltip">
                                     {{$invoice->projects ? $invoice->projects->name : 'N/A' }}
                                 </div>
                            ...
                            <span class="d-table-row w-100">
                                <b class="d-table-cell w-50"><span class="font-weight-bold currency-icon-font">
                                             $
                                        </span> {{ $invoice->total_bill }}
                                </b>
                                <span class="badge-success badge text-uppercase">{{ $invoice->status }}</span>
                            </span>
                                                </div>
                    </div>
                </div>
