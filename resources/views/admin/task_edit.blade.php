        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.task_update',$tasks->id) }}" method="POST" id="editForm" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('admin.task') }}" class="btn btn-danger"  data-dismiss="modal">Cancel</a>
