            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <img id='showImage' class="img-thumbnail thumbnail-preview" src="https://ui-avatars.com/api/?name={{ $task->users->name }}&amp;size=40&amp;rounded=true&amp;color=fff&amp;background=fc6369">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                      <label for="created_at" class="font-weight-bold">Task Image:</label>
                      <br>
                      {{-- <span data-toggle="tooltip" data-placement="right">{{ $task->image }}</span> --}}
                      @if ($task->image != "")
                      @foreach(json_decode($task->image) as $info) 
                      <p >
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <br>
                        <span data-toggle="tooltip" data-placement="right">{{ $task->Description }}</span>
                    </div>
                </div>               
              </div>
            </div>
