                ...
                <div class="modal fade" id="addmenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.role_store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox"  name="permission[]" value="Manage Calendar View">
                                        <label > Manage Calendar View </label><br>
                                        <input type="checkbox"  name="permission[]" value="Manage Clients" >
                                        <label > Manage Clients</label><br>
                                        <input type="checkbox"  name="permission[]" value="Manage User">
                                        <label > Manage Users</label><br>
                                        <input type="checkbox"  name="permission[]" value="Manage Roles">
                                        <label > Manage  Roles </label><br>
                                        <input type="checkbox"  name="permission[]" value="Manage Tasks">
                                        <label > Manage Tasks</label><br>
                                        <input type="checkbox"  name="permission[]" value="Manage Projects">
            ...
            <div class="col-md-4">
              <div class="livewire-card card author-box shadow mb-5 rounded client-card-view hover-card "style="border-top: 3px solid #800080">
                <div class="card-header d-flex justify-content-between align-items-center p-3 role-cards ">
                    <a href="{{ route('admin.roles_details',$role->id) }}"><h4
                                class="text-purple ml-3">{{$role->name}}</h4></a>
                    <a class="dropdown dropdown-list-toggle ml-auto" ><a href="#" data-toggle="dropdown"
                                class="notification-toggle action-dropdown ml-5"><i
                                    class="fas fa-ellipsis-v" style="color: purple;"></i></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-list-content dropdown-list-icons">
                                <a href="{{ route('admin.role_edit',$role->id) }}"
                                   class="dropdown-item dropdown-item-desc edit-btn"
                                   data-id="1"><i
                                            class="fas fa-edit mr-2 card-edit-icon"></i> Edit
                                </a>
                                <a href="{{ route('admin.role_delete',$role->id )}}" class="dropdown-item dropdown-item-desc delete-btn"
                                   data-id="1"><i
